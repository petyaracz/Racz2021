...
We take each predictor and draw predictions from Fit 4 (our favourite fit) for societies at each of its levels. Then, we calculate the mean and the standard deviation and plot these against each other, levels of the predictor on the x axis, predictions for the five levels of the outcome on the y axis.
...
vals = c("Slavery_type","Religion_high_gods","Class_differentiation_primary","Settlement_patterns","Descent_major_type")

p.list = map(vals, ~ predPlot(.))
