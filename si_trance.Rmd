...
p3 = predPlot("Class_differentiation_primary") + min_theme
p4 = predPlot("Settlement_patterns") + min_theme
p5 = predPlot("Descent_major_type") + right_theme + scale_y_continuous(limits = c(0,0.6), position = 'right', name = 'mean predicted probability')
